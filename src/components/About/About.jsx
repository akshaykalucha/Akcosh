                ...
                <div className="Aboutmewrapper">
                    ...
                    <div className="aboutmeContent">
                        <div className="aboutIntro">
                            <p className="aboutp">I’m Akshay Kalucha, also known as Akcosh, I’m a self-taught software developer, Graphic, UI/UX Designer
                    ...
                    <div className="aboutcontact">
                        <h2 className="abouth2">Or somewhere else on the web</h2>
                        <div className="contactlinks">
                            <div className="contactlogo">
                                <a target="_blank" rel="noopener noreferrer" href="https://www.github.com/akshaykalucha3">
                                    <img src={github} alt="" />
                                    Github
                                </a>
                            </div>
                            <div className="contactlogo">
                                <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/akshaykalucha/">
                                    <img src={linkedin} alt="" />
                                    Linkedin
                                </a>
                            </div>
                            <div className="contactlogo">
                                <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/lifeofakshy">
                                    <img src={instagram} alt="" />
                                    Instagram
                                </a>
                            </div>
                            <div className="contactlogo">
                                <a target="_blank" rel="noopener noreferrer" href="https://www.twitter.com/lifeofakshy">
                                    <img src={twitter} alt="" />
                                    Twitter
                                </a>
                            </div>
                            <div className="contactlogo">
                                <a target="_blank" rel="noopener noreferrer" href="https://www.snapchat.com/akshaykalucha3">
